  ...
  return (
    <div className="w-full">
      <div className="mb-8">
        ...
        <p className="text-sm text-warm-300 mt-2">Sign in to manage your property and payments.</p>
      </div>
      ...
      <div className="mt-8 pt-6 border-t border-ink-800/80 text-center">
        ...
        <button onClick={() => onSwitchView('signup')} className="text-sm text-coral-500 hover:underline font-semibold ml-1">
          Sign up
        </button>
      </div>
    </div>
