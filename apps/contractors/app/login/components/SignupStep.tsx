          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-ink-950 border border-ink-700 rounded pl-9 pr-3 py-2.5 text-sm text-warm-100 placeholder-ink-600 focus:outline-none focus:border-coral-500 focus:ring-1 focus:ring-coral-500/30 transition-all"
              />
            </div>
          </div>
          <div className="flex flex-col gap-1.5">
