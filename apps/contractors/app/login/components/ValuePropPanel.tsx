...
export default function ValuePropPanel() {
  return (
    <div className="auth-left-panel border-b md:border-b-0 md:border-r border-ink-800 flex flex-col relative overflow-hidden hidden md:flex shrink-0 w-5/12">
      <img src="https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&w=800&q=80" alt="Modern Architecture" className="absolute inset-0 w-full h-full object-cover z-0 grayscale-[30%] opacity-40" />
      ...
      <div className="p-8 lg:p-10 flex flex-col h-full justify-between relative z-10">
        <div className="flex items-center gap-2.5">
          ...
          <span className="font-heading font-bold text-xl tracking-tight text-white leading-none">Nexis</span>
        </div>
          ...
          <ul className="flex flex-col gap-4 text-sm text-warm-200">
            <li className="flex items-center gap-3">
              <div className="w-6 h-6 rounded bg-ink-800/80 border border-ink-700 flex items-center justify-center text-coral-500 shrink-0">
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"></rect><line x1="9" y1="22" x2="15" y2="22"></line><line x1="12" y1="18" x2="12" y2="22"></line></svg>
              </div>
              <span>Coordinate property portfolios and leases.</span>
            </li>
            <li className="flex items-center gap-3">
              <div className="w-6 h-6 rounded bg-ink-800/80 border border-ink-700 flex items-center justify-center text-coral-500 shrink-0">
              ...
              <span>Resolve maintenance tickets and repair logs.</span>
            </li>
            <li className="flex items-center gap-3">
              <div className="w-6 h-6 rounded bg-ink-800/80 border border-ink-700/80 flex items-center justify-center text-coral-500 shrink-0">
              ...
              <span>Secure, real-time message updates.</span>
            </li>
          </ul>
        </div>
      </div>
